...
{
    partial class TimeIncrementChoice
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TimeIncrementChoice));
            buttonTimeIncrementChoiceToMenu = new Button();
            buttonTimeIncrementChoiceToBack = new Button();
            buttonTimeIncrementChoiceSettings = new Button();
            labelTimeIncrementChoiceHeading = new Label();
            buttonTimeIncrementChoice0sec = new Button();
        ...
        private Button buttonTimeIncrementChoiceToMenu;
        private Button buttonTimeIncrementChoiceToBack;
        private Button buttonTimeIncrementChoiceSettings;
        private Label labelTimeIncrementChoiceHeading;
        private Button buttonTimeIncrementChoice0sec;
